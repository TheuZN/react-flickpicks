...
export default function DevList() {
    ...
    const options = {
      ...
      useEffect(() => {
        fetch('https://api.themoviedb.org/3/account/20162127/watchlist/movies?language=en-US&page=1&sort_by=created_at.asc', options)
    ...
    return (
        <section className="gallery-trend">
            <div className="wrapper">
                <h2 className="title">Dev List <img class="ico" src="/img/ico-new.svg" alt=""></img></h2>
